...
(
    ...
    `is_deleted`   tinyint(1)                    NOT NULL DEFAULT '0' COMMENT '0 正常 1 逻辑删除',
    PRIMARY KEY (`id`),
...
(
    ...
    `version_value`       varchar(25) COLLATE utf8_bin          DEFAULT '' COMMENT '组件 hadoop 版本',
    `upload_file_name`    varchar(126) COLLATE utf8_bin         DEFAULT '' COMMENT '上传文件 zip 名称',
    `kerberos_file_name`  varchar(126) COLLATE utf8_bin         DEFAULT '' COMMENT '上传 kerberos 文件 zip 名称',
    `store_type`          tinyint(1)                            DEFAULT '4' COMMENT '组件存储类型：HDFS、NFS 默认 HDFS',
...
(
    `id`                  int(11)                       NOT NULL AUTO_INCREMENT,
    `cluster_id`          int(11)                       NOT NULL COMMENT '集群 id',
    `component_id`        int(11)                       NOT NULL COMMENT '组件 id',
    `component_type_code` tinyint(1)                    NOT NULL COMMENT '组件类型',
...
CREATE TABLE `console_kerberos` (
                                    ...
                                    `cluster_id`        int(11)                       NOT NULL COMMENT '集群 id',
                                    `open_kerberos`     tinyint(1)                    NOT NULL COMMENT '是否开启 kerberos 配置',
                                    `name`              varchar(100) COLLATE utf8_bin NOT NULL COMMENT 'kerberos 文件名称',
                                    `remote_path`       varchar(200) COLLATE utf8_bin NOT NULL COMMENT 'sftp 存储路径',
                                    `principal`         varchar(50) COLLATE utf8_bin  NOT NULL COMMENT 'principal',
                                    `gmt_create`        datetime                      NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                    `gmt_modified`      datetime                      NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
                                    `is_deleted`        tinyint(1)                    NOT NULL DEFAULT '0' COMMENT '0 正常 1 逻辑删除',
                                    `krb_name`          varchar(26) COLLATE utf8_bin           DEFAULT NULL COMMENT 'krb5_conf 名称',
                                    `component_type`    int(11)                                DEFAULT NULL COMMENT '组件类型',
                                    `principals`        text COLLATE utf8_bin COMMENT 'keytab 用户文件列表',
                                    `merge_krb_content` text COLLATE utf8_bin COMMENT '合并后的 krb5',
                                    `component_version` varchar(25) COLLATE utf8_bin           DEFAULT NULL COMMENT '组件版本',
                                    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8
  COLLATE = utf8_bin COMMENT ='组件 kerberos 配置表';
...
(
    ...
    `parent_queue_id` int(11)                       NOT NULL COMMENT '父队列 id',
...
(
    ...
    `sorted`        int(5)                       NOT NULL DEFAULT '0' COMMENT '类型栏排序字段 默认从 0 开始',
...
CREATE TABLE `datasource_form_field` (
  ...
  `label` varchar(64) COLLATE utf8_bin NOT NULL COMMENT '属性前 label 名称',
  `widget` varchar(64) COLLATE utf8_bin NOT NULL COMMENT '属性格式 如 Input, Radio 等',
  ...
  `place_hold` text COLLATE utf8_bin COMMENT '输入框 placeHold, 默认为空',
  `request_api` varchar(256) COLLATE utf8_bin DEFAULT NULL COMMENT '请求数据 Api 接口地址，一般用于关联下拉框类型，如果不需要请求则为空',
  ...
  `create_user_id` int(11) DEFAULT '0',
  `modify_user_id` int(11) DEFAULT '0',
  `options` varchar(256) COLLATE utf8_bin DEFAULT '' COMMENT 'select 组件下拉内容',
  PRIMARY KEY (`id`),
...
-- ----------------------------
BEGIN;
INSERT INTO `datasource_form_field` VALUES (1, 'dataName', '数据源名称', 'Input', 1, 0, NULL, NULL, NULL, 0, '{\"length\":{\"max\":128, \"message\":\"不得超过 128 个字符\"}}', NULL, NULL, NULL, 'common', 0, '2021-03-15 17:33:21', '2021-03-30 16:09:06', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (3, 'dataDesc', '描述', 'TextArea', 0, 0, NULL, NULL, NULL, 0, '{\"length\":{\"max\":200, \"message\":\"不得超过 200 个字符\"}}', NULL, NULL, NULL, 'common', 0, '2021-03-15 17:33:21', '2021-03-30 16:09:15', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (5, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:mysql://host:3306/dbName', NULL, '/jdbc:mysql:\\/\\/(.)+/', 'MySQL', 0, '2021-03-23 20:35:57', '2021-07-28 16:06:50', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (11, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:mysql://host:port/dbName', NULL, '/jdbc:mysql:\\/\\/(.)+/', 'PolarDB for MySQL8', 0, '2021-03-23 20:35:57', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (17, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', 'SID 示例：jdbc:oracle:thin:@host:port:dbName\nServiceName 示例：jdbc:oracle:thin:@//host:port/service_name', NULL, '/jdbc:oracle:thin:@(\\/\\/)?(.)+/', 'Oracle', 0, '2021-03-23 20:35:57', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (29, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:postgresql://host:port/database', NULL, '/jdbc:postgresql:\\/\\/(.)+/', 'PostgreSQL', 0, '2021-03-23 20:35:57', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (35, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:db2://host:port/dbName', NULL, '/jdbc:db2:\\/\\/(.)+/', 'DB2', 0, '2021-03-23 20:35:58', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (41, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:dm://host:port/database', NULL, '/jdbc:dm:\\/\\/(.)+/', 'DMDB', 0, '2021-03-23 20:35:58', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (47, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:kingbase8://host:port/database', NULL, '/jdbc:kingbase8:\\/\\/(.)+/', 'KingbaseES8', 0, '2021-03-23 20:35:58', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (53, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:pivotal:greenplum://host:port;DatabaseName=database', NULL, '/jdbc:pivotal:greenplum:\\/\\/(.)+/', 'Greenplum', 0, '2021-03-23 20:35:58', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (59, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:postgresql://host:port/database', NULL, '/jdbc:postgresql:\\/\\/(.)+/', 'GaussDB', 0, '2021-03-23 20:35:58', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (65, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:gbase://host:port/dbName', NULL, '/jdbc:gbase:\\/\\/(.)+/', 'GBase_8a', 0, '2021-03-23 20:35:58', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (71, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:clickhouse://<host>:<port>[/<database>]', NULL, '/jdbc:clickhouse:\\/\\/(.)+/', 'ClickHouse', 0, '2021-03-23 20:35:58', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (77, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:mysql://host:port/dbName', NULL, '/jdbc:mysql:\\/\\/(.)+/', 'TiDB', 0, '2021-03-23 20:35:58', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (83, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:mysql://host:port/dbName', NULL, '/jdbc:mysql:\\/\\/(.)+/', 'AnalyticDB', 0, '2021-03-23 20:35:58', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (89, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:hive://host:port/dbName', NULL, '/jdbc:(\\w|:)+:\\/\\/(.)+/', 'Hive-1.x', 0, '2021-03-23 20:37:29', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (97, 'hadoopConfig', '高可用配置', 'TextAreaWithCopy', 0, 0, NULL, '{\n\"dfs.nameservices\": \"defaultDfs\",\n\"dfs.ha.namenodes.defaultDfs\": \"namenode1\",\n\"dfs.namenode.rpc-address.defaultDfs.namenode1\": \"\",\n\"dfs.client.failover.proxy.provider.defaultDfs\": \"org.apache.hadoop.hdfs.server.namenode.ha.ConfiguredFailoverProxyProvider\"\n}', NULL, 0, '', '高可用模式下的填写规则：\n1、分别要填写：nameservice 名称、namenode 名称（多个以逗号分隔）、proxy.provider 参数；\n2、所有参数以 JSON 格式填写；\n3、格式为：\n\"dfs.nameservices\": \"nameservice 名称\", \"dfs.ha.namenodes.nameservice 名称\": \"namenode 名称，以逗号分隔\", \"dfs.namenode.rpc-address.nameservice 名称.namenode 名称\": \"\", \"dfs.namenode.rpc-address.nameservice 名称.namenode 名称\": \"\", \"dfs.client.failover.proxy.provider.\nnameservice 名称\": \"org.apache.hadoop.\nhdfs.server.namenode.ha.\nConfiguredFailoverProxyProvider\"\n4、详细参数含义请参考《帮助文档》或<a href=\'http://hadoop.apache.org/docs/r2.7.4/hadoop-project-dist/hadoop-hdfs/HDFSHighAvailabilityWithQJM.html\'>Hadoop 官方文档</a>', NULL, NULL, 'Hive-1.x', 0, '2021-03-23 20:37:29', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (99, 'openKerberos', '开启 Kerberos 认证', 'Kerberos', 0, 0, NULL, NULL, NULL, 0, '', NULL, NULL, NULL, 'Hive-1.x', 0, '2021-03-23 20:37:29', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (101, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:hive2://host:port/dbName', NULL, '/jdbc:(\\w|:)+:\\/\\/(.)+/', 'Hive-2.x', 0, '2021-03-23 20:37:30', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (109, 'hadoopConfig', '高可用配置', 'TextAreaWithCopy', 0, 0, NULL, '{\n\"dfs.nameservices\": \"defaultDfs\",\n\"dfs.ha.namenodes.defaultDfs\": \"namenode1\",\n\"dfs.namenode.rpc-address.defaultDfs.namenode1\": \"\",\n\"dfs.client.failover.proxy.provider.defaultDfs\": \"org.apache.hadoop.hdfs.server.namenode.ha.ConfiguredFailoverProxyProvider\"\n}', NULL, 0, '', '高可用模式下的填写规则：\n1、分别要填写：nameservice 名称、namenode 名称（多个以逗号分隔）、proxy.provider 参数；\n2、所有参数以 JSON 格式填写；\n3、格式为：\n\"dfs.nameservices\": \"nameservice 名称\", \"dfs.ha.namenodes.nameservice 名称\": \"namenode 名称，以逗号分隔\", \"dfs.namenode.rpc-address.nameservice 名称.namenode 名称\": \"\", \"dfs.namenode.rpc-address.nameservice 名称.namenode 名称\": \"\", \"dfs.client.failover.proxy.provider.\nnameservice 名称\": \"org.apache.hadoop.\nhdfs.server.namenode.ha.\nConfiguredFailoverProxyProvider\"\n4、详细参数含义请参考《帮助文档》或<a href=\'http://hadoop.apache.org/docs/r2.7.4/hadoop-project-dist/hadoop-hdfs/HDFSHighAvailabilityWithQJM.html\'>Hadoop 官方文档</a>', NULL, NULL, 'Hive-2.x', 0, '2021-03-23 20:37:30', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (111, 'openKerberos', '开启 Kerberos 认证', 'Kerberos', 0, 0, NULL, NULL, NULL, 0, '', NULL, NULL, NULL, 'Hive-2.x', 0, '2021-03-23 20:37:30', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (113, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:hive2://host:port/dbName', NULL, '/jdbc:hive2:\\/\\/(.)+/', 'SparkThrift', 0, '2021-03-23 20:37:30', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (121, 'hadoopConfig', '高可用配置', 'TextAreaWithCopy', 0, 0, NULL, '{\n\"dfs.nameservices\": \"defaultDfs\",\n\"dfs.ha.namenodes.defaultDfs\": \"namenode1\",\n\"dfs.namenode.rpc-address.defaultDfs.namenode1\": \"\",\n\"dfs.client.failover.proxy.provider.defaultDfs\": \"org.apache.hadoop.hdfs.server.namenode.ha.ConfiguredFailoverProxyProvider\"\n}', NULL, 0, '', '高可用模式下的填写规则：\n1、分别要填写：nameservice 名称、namenode 名称（多个以逗号分隔）、proxy.provider 参数；\n2、所有参数以 JSON 格式填写；\n3、格式为：\n\"dfs.nameservices\": \"nameservice 名称\", \"dfs.ha.namenodes.nameservice 名称\": \"namenode 名称，以逗号分隔\", \"dfs.namenode.rpc-address.nameservice 名称.namenode 名称\": \"\", \"dfs.namenode.rpc-address.nameservice 名称.namenode 名称\": \"\", \"dfs.client.failover.proxy.provider.\nnameservice 名称\": \"org.apache.hadoop.\nhdfs.server.namenode.ha.\nConfiguredFailoverProxyProvider\"\n4、详细参数含义请参考《帮助文档》或<a href=\'http://hadoop.apache.org/docs/r2.7.4/hadoop-project-dist/hadoop-hdfs/HDFSHighAvailabilityWithQJM.html\'>Hadoop 官方文档</a>', NULL, NULL, 'SparkThrift', 0, '2021-03-23 20:37:30', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (123, 'openKerberos', '开启 Kerberos 认证', 'Kerberos', 0, 0, NULL, NULL, NULL, 0, '', NULL, NULL, NULL, 'SparkThrift', 0, '2021-03-23 20:37:30', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (125, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:impala://host:port/dbName', NULL, '/jdbc:impala:\\/\\/(.)+/', 'Impala', 0, '2021-03-23 20:37:30', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (133, 'hadoopConfig', '高可用配置', 'TextAreaWithCopy', 0, 0, NULL, '{\n\"dfs.nameservices\": \"defaultDfs\",\n\"dfs.ha.namenodes.defaultDfs\": \"namenode1\",\n\"dfs.namenode.rpc-address.defaultDfs.namenode1\": \"\",\n\"dfs.client.failover.proxy.provider.defaultDfs\": \"org.apache.hadoop.hdfs.server.namenode.ha.ConfiguredFailoverProxyProvider\"\n}', NULL, 0, '', '高可用模式下的填写规则：\n1、分别要填写：nameservice 名称、namenode 名称（多个以逗号分隔）、proxy.provider 参数；\n2、所有参数以 JSON 格式填写；\n3、格式为：\n\"dfs.nameservices\": \"nameservice 名称\", \"dfs.ha.namenodes.nameservice 名称\": \"namenode 名称，以逗号分隔\", \"dfs.namenode.rpc-address.nameservice 名称.namenode 名称\": \"\", \"dfs.namenode.rpc-address.nameservice 名称.namenode 名称\": \"\", \"dfs.client.failover.proxy.provider.\nnameservice 名称\": \"org.apache.hadoop.\nhdfs.server.namenode.ha.\nConfiguredFailoverProxyProvider\"\n4、详细参数含义请参考《帮助文档》或<a href=\'http://hadoop.apache.org/docs/r2.7.4/hadoop-project-dist/hadoop-hdfs/HDFSHighAvailabilityWithQJM.html\'>Hadoop 官方文档</a>', NULL, NULL, 'Impala', 0, '2021-03-23 20:37:30', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (135, 'openKerberos', '开启 Kerberos 认证', 'Kerberos', 0, 0, NULL, NULL, NULL, 0, '', NULL, NULL, NULL, 'Impala', 0, '2021-03-23 20:37:30', '2021-03-30 16:08:46', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (147, 'port', '端口', 'Integer', 1, 0, NULL, 'FTP 默认 21, SFTP 默认 22', NULL, 1, '', NULL, NULL, NULL, 'FTP', 0, '2021-03-23 20:38:06', '2021-03-30 16:08:46', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (155, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:hive2://host:port/dbName', NULL, '/jdbc:(\\w|:)+:\\/\\/(.)+/\n', 'CarbonData', 0, '2021-03-23 20:38:06', '2021-03-30 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (163, 'hostPorts', '集群地址', 'TextArea', 1, 0, NULL, '集群地址，例如：IP1:Port,IP2:Port,IP3:Port3，多个 IP 地址用英文逗号隔开', NULL, 1, '', NULL, NULL, NULL, 'Kudu', 0, '2021-03-23 20:38:06', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (165, 'others', '其他参数', 'TextAreaWithCopy', 0, 0, NULL, '输入 JSON 格式的参数，示例及默认参数如下：\n{\n    \"openKerberos\":false,\n    \"user\":\"\",\n    \"keytabPath\":\"\",\n    \"workerCount\":4,\n    \"bossCount\":1,\n    \"operationTimeout\":30000,\n    \"adminOperationTimeout\":30000\n}', NULL, 0, '', NULL, NULL, NULL, 'Kudu', 0, '2021-03-23 20:38:06', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (167, 'openKerberos', '开启 Kerberos 认证', 'Kerberos', 0, 0, NULL, NULL, NULL, 0, '', NULL, NULL, NULL, 'Kudu', 0, '2021-03-23 20:38:06', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (169, 'authURL', 'RESTful URL', 'Input', 1, 0, NULL, 'http://ip:port', NULL, 1, '', '访问 Kylin 的认证地址，格式为：http://host:7000', NULL, '/http:\\/\\/([\\w, .])+:(.)+/', 'Kylin URL-3.x', 0, '2021-03-23 20:38:06', '2021-07-28 16:06:35', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (181, 'hbase_parent', '根目录', 'Input', 0, 0, NULL, 'ZooKeeper 中 hbase 创建的根目录，例如：/hbase', NULL, 0, '', NULL, NULL, NULL, 'HBase-1.x', 0, '2021-03-23 20:38:06', '2021-03-30 16:08:46', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (185, 'openKerberos', '开启 Kerberos 认证', 'HbaseKerberos', 0, 0, NULL, NULL, NULL, 0, '', NULL, NULL, NULL, 'HBase-1.x', 0, '2021-03-23 20:38:06', '2021-03-30 16:08:46', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (189, 'hbase_parent', '根目录', 'Input', 0, 0, NULL, 'ZooKeeper 中 hbase 创建的根目录，例如：/hbase', NULL, 0, '', NULL, NULL, NULL, 'HBase-2.x', 0, '2021-03-23 20:38:07', '2021-03-30 16:08:46', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (193, 'openKerberos', '开启 Kerberos 认证', 'HbaseKerberos', 0, 0, NULL, NULL, NULL, 0, '', NULL, NULL, NULL, 'HBase-2.x', 0, '2021-03-23 20:38:07', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (195, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:phoenix:zk1,zk2,zk3:port/hbase2', NULL, '/jdbc:phoenix:(.)+/', 'Phoenix-4.x', 0, '2021-03-23 20:38:07', '2021-03-30 16:07:17', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (197, 'openKerberos', '开启 Kerberos 认证', 'Kerberos', 0, 0, NULL, NULL, NULL, 0, '', NULL, NULL, NULL, 'Phoenix-4.x', 0, '2021-03-23 20:38:07', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (199, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:phoenix:zk1,zk2,zk3:port/hbase2', NULL, '/jdbc:phoenix:(.)+/', 'Phoenix-5.x', 0, '2021-03-23 20:38:07', '2021-03-30 16:07:17', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (201, 'openKerberos', '开启 Kerberos 认证', 'Kerberos', 0, 0, NULL, NULL, NULL, 0, '', NULL, NULL, NULL, 'Phoenix-5.x', 0, '2021-03-23 20:38:07', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (203, 'address', '集群地址', 'TextArea', 1, 0, NULL, '集群地址，单个节点地址采用 host:port 形式，多个节点的地址用逗号连接', NULL, 1, '', NULL, NULL, NULL, 'Elasticsearch-5.x', 0, '2021-03-23 20:38:07', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (205, 'clusterName', '集群名称', 'Input', 0, 0, NULL, '请输入集群名称', NULL, 0, '{\"length\":{\"max\":128, \"message\":\"不得超过 128 个字符\"}}', NULL, NULL, NULL, 'Elasticsearch-5.x', 0, '2021-03-23 20:38:07', '2021-07-28 16:05:37', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (211, 'address', '集群地址', 'TextArea', 1, 0, NULL, '集群地址，单个节点地址采用 host:port 形式，多个节点的地址用逗号连接', NULL, 1, '', NULL, NULL, NULL, 'Elasticsearch-6.x', 0, '2021-03-23 20:38:07', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (213, 'clusterName', '集群名称', 'Input', 0, 0, NULL, '请输入集群名称', NULL, 0, '{\"length\":{\"max\":128, \"message\":\"不得超过 128 个字符\"}}', NULL, NULL, NULL, 'Elasticsearch-6.x', 0, '2021-03-23 20:38:07', '2021-07-28 16:05:37', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (219, 'address', '集群地址', 'TextArea', 1, 0, NULL, '集群地址，单个节点地址采用 host:port 形式，多个节点的地址用逗号连接', NULL, 1, '', NULL, NULL, NULL, 'Elasticsearch-7.x', 0, '2021-03-23 20:38:07', '2021-03-30 16:08:46', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (221, 'clusterName', '集群名称', 'Input', 0, 0, NULL, '请输入集群名称', NULL, 0, '{\"length\":{\"max\":128, \"message\":\"不得超过 128 个字符\"}}', NULL, NULL, NULL, 'Elasticsearch-7.x', 0, '2021-03-23 20:38:07', '2021-07-28 16:05:37', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (227, 'hostPorts', '集群地址', 'TextArea', 1, 0, NULL, 'MongoDB 集群地址，例如：IP1:Port,IP2:Port,IP3:Port', NULL, 1, '', NULL, NULL, NULL, 'MongoDB', 0, '2021-03-23 20:38:07', '2021-03-30 16:08:46', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (243, 'address', '集群地址', 'TextArea', 0, 1, NULL, '请填写 Kafka 对应的 ZooKeeper 集群地址，例如：IP1:Port,IP2：Port,IP3：Port/子目录', NULL, 1, '', NULL, NULL, NULL, 'Kafka-1.x', 0, '2021-03-23 20:38:07', '2021-04-13 17:37:38', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (245, 'brokerList', 'broker 地址', 'TextArea', 1, 1, NULL, 'Broker 地址，例如 IP1:Port,IP2:Port,IP3:Port/子目录', NULL, 1, '', NULL, NULL, NULL, 'Kafka-1.x', 0, '2021-03-23 20:38:07', '2021-04-13 17:37:39', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (247, 'address', '集群地址', 'TextArea', 0, 1, NULL, '请填写 Kafka 对应的 ZooKeeper 集群地址，例如：IP1:Port,IP2：Port,IP3：Port/子目录', NULL, 1, '', NULL, NULL, NULL, 'Kafka-2.x', 0, '2021-03-23 20:38:07', '2021-04-13 17:37:40', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (249, 'brokerList', 'broker 地址', 'TextArea', 1, 1, NULL, 'Broker 地址，例如 IP1:Port,IP2:Port,IP3:Port/子目录', NULL, 1, '', NULL, NULL, NULL, 'Kafka-2.x', 0, '2021-03-23 20:38:07', '2021-04-13 17:37:41', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (251, 'address', '集群地址', 'TextArea', 0, 1, NULL, '请填写 Kafka 对应的 ZooKeeper 集群地址，例如：IP1:Port,IP2：Port,IP3：Port/子目录', NULL, 1, '', NULL, NULL, NULL, 'Kafka-0.9', 0, '2021-03-23 20:38:07', '2021-04-13 17:37:41', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (253, 'brokerList', 'broker 地址', 'TextArea', 1, 1, NULL, 'Broker 地址，例如 IP1:Port,IP2:Port,IP3:Port/子目录', NULL, 1, '', NULL, NULL, NULL, 'Kafka-0.9', 0, '2021-03-23 20:38:07', '2021-04-13 17:37:43', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (255, 'address', '集群地址', 'TextArea', 0, 1, NULL, '请填写 Kafka 对应的 ZooKeeper 集群地址，例如：IP1:Port,IP2：Port,IP3：Port/子目录', NULL, 1, '', NULL, NULL, NULL, 'Kafka-0.10', 0, '2021-03-23 20:38:07', '2021-04-13 17:37:43', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (257, 'brokerList', 'broker 地址', 'TextArea', 1, 1, NULL, 'Broker 地址，例如 IP1:Port,IP2:Port,IP3:Port/子目录', NULL, 1, '', NULL, NULL, NULL, 'Kafka-0.10', 0, '2021-03-23 20:38:07', '2021-04-13 17:37:45', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (259, 'address', '集群地址', 'TextArea', 0, 1, NULL, '请填写 Kafka 对应的 ZooKeeper 集群地址，例如：IP1:Port,IP2：Port,IP3：Port/子目录', NULL, 1, '', NULL, NULL, NULL, 'Kafka-0.11', 0, '2021-03-23 20:38:07', '2021-04-13 17:37:45', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (261, 'brokerList', 'broker 地址', 'TextArea', 1, 1, NULL, 'Broker 地址，例如 IP1:Port,IP2:Port,IP3:Port/子目录', NULL, 1, '', NULL, NULL, NULL, 'Kafka-0.11', 0, '2021-03-23 20:38:07', '2021-04-13 17:37:46', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (269, 'url', 'URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '', '多个鉴权参数将以”&“连接拼接在 URL 后，例如：ws://host:port/test?Username=sanshui&password=xx', NULL, NULL, 'WebSocket', 0, '2021-03-23 20:38:07', '2021-03-30 16:08:46', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (277, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:presto://host:port/dbName', NULL, '/jdbc:presto:\\/\\/(.)+/', 'Presto', 0, '2021-04-07 14:47:08', '2021-04-07 14:47:14', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (289, 'chroot', 'chroot', 'Input', 1, 0, NULL, '请输入 Zookeeper chroot 路径，例如/Solr', NULL, 1, NULL, NULL, NULL, NULL, 'Solr-7.x', 0, '2021-05-28 14:07:00', '2021-05-28 14:07:00', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (291, 'openKerberos', '开启 Kerberos 认证', 'Kerberos', 0, 0, NULL, NULL, NULL, 0, '', NULL, NULL, NULL, 'Solr-7.x', 0, '2021-03-23 20:37:29', '2021-03-30 16:08:46', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (303, 'url', 'URL', 'Input', 1, 0, NULL, 'http://localhost:8086', NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', NULL, NULL, '/http:\\/\\/([\\w, .])+:(.)+/', 'InfluxDB-1.x', 0, '2021-06-09 14:49:27', '2021-06-09 14:49:42', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (309, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:hive://host:port/dbName', NULL, '/jdbc:(\\w|:)+:\\/\\/(.)+/', 'Hive-3.x', 0, '2021-06-09 14:49:27', '2021-06-09 14:49:42', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (317, 'hadoopConfig', '高可用配置', 'TextAreaWithCopy', 0, 0, NULL, '{\n\"dfs.nameservices\": \"defaultDfs\",\n\"dfs.ha.namenodes.defaultDfs\": \"namenode1\",\n\"dfs.namenode.rpc-address.defaultDfs.namenode1\": \"\",\n\"dfs.client.failover.proxy.provider.defaultDfs\": \"org.apache.hadoop.hdfs.server.namenode.ha.ConfiguredFailoverProxyProvider\"\n}', NULL, 0, '', '高可用模式下的填写规则：\n1、分别要填写：nameservice 名称、namenode 名称（多个以逗号分隔）、proxy.provider 参数；\n2、所有参数以 JSON 格式填写；\n3、格式为：\n\"dfs.nameservices\": \"nameservice 名称\", \"dfs.ha.namenodes.nameservice 名称\": \"namenode 名称，以逗号分隔\", \"dfs.namenode.rpc-address.nameservice 名称.namenode 名称\": \"\", \"dfs.namenode.rpc-address.nameservice 名称.namenode 名称\": \"\", \"dfs.client.failover.proxy.provider.\nnameservice 名称\": \"org.apache.hadoop.\nhdfs.server.namenode.ha.\nConfiguredFailoverProxyProvider\"\n4、详细参数含义请参考《帮助文档》或<a href=\'http://hadoop.apache.org/docs/r2.7.4/hadoop-project-dist/hadoop-hdfs/HDFSHighAvailabilityWithQJM.html\'>Hadoop 官方文档</a>', NULL, NULL, 'Hive-3.x', 0, '2021-06-09 14:49:27', '2021-06-09 14:49:42', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (319, 'openKerberos', '开启 Kerberos 认证', 'Kerberos', 0, 0, NULL, NULL, NULL, 0, '', NULL, NULL, NULL, 'Hive-3.x', 0, '2021-06-09 14:49:27', '2021-06-09 14:49:42', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (327, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:hive2://host:port/dbName', NULL, '/jdbc:(\\w|:)+:\\/\\/(.)+/', 'Inceptor', 0, '2021-06-21 22:07:27', '2021-06-21 22:07:27', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (335, 'metaStoreUris', 'hive.metastore.uris', 'Input', 0, 0, NULL, '', NULL, 0, '', 'hive.metastore.uris 仅在做事务表的写同步时必填', NULL, NULL, 'Inceptor', 0, '2021-06-21 22:07:27', '2021-06-21 22:07:27', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (337, 'hadoopConfig', '高可用配置', 'TextAreaWithCopy', 0, 0, NULL, '{\n\"dfs.nameservices\": \"defaultDfs\",\n\"dfs.ha.namenodes.defaultDfs\": \"namenode1\",\n\"dfs.namenode.rpc-address.defaultDfs.namenode1\": \"\",\n\"dfs.client.failover.proxy.provider.defaultDfs\": \"org.apache.hadoop.hdfs.server.namenode.ha.ConfiguredFailoverProxyProvider\"\n}', NULL, 0, '', '高可用模式下的填写规则：\n1、分别要填写：nameservice 名称、namenode 名称（多个以逗号分隔）、proxy.provider 参数；\n2、所有参数以 JSON 格式填写；\n3、格式为：\n\"dfs.nameservices\": \"nameservice 名称\", \"dfs.ha.namenodes.nameservice 名称\": \"namenode 名称，以逗号分隔\", \"dfs.namenode.rpc-address.nameservice 名称.namenode 名称\": \"\", \"dfs.namenode.rpc-address.nameservice 名称.namenode 名称\": \"\", \"dfs.client.failover.proxy.provider.\nnameservice 名称\": \"org.apache.hadoop.\nhdfs.server.namenode.ha.\nConfiguredFailoverProxyProvider\"\n4、详细参数含义请参考《帮助文档》或<a href=\'http://hadoop.apache.org/docs/r2.7.4/hadoop-project-dist/hadoop-hdfs/HDFSHighAvailabilityWithQJM.html\'>Hadoop 官方文档</a>', NULL, NULL, 'Inceptor', 0, '2021-06-21 22:07:27', '2021-06-21 22:07:27', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (339, 'openKerberos', '开启 Kerberos 认证', 'Kerberos', 0, 0, NULL, NULL, NULL, 0, '', NULL, NULL, NULL, 'Inceptor', 0, '2021-06-21 22:07:27', '2021-06-21 22:07:27', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (341, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:postgresql://host:port/database', NULL, '/jdbc:postgresql:\\/\\/(.)+/', 'AnalyticDB PostgreSQL', 0, '2021-06-01 12:22:10', '2021-06-01 12:22:10', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (347, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:vertica://host:port/dbName', NULL, '/jdbc:vertica:\\/\\/(.)+/', 'Vertica', 0, '2021-06-01 12:22:10', '2021-06-01 12:22:10', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (353, 'url', 'URL', 'Input', 1, 0, NULL, 'http://localhost:4242', NULL, 1, '{\"regex\":{\"message\":\"URL 格式不符合规则!\"}}', NULL, NULL, '/http:\\/\\/([\\w, .])+:(.)+/', 'OpenTSDB-2.x', 0, '2021-07-06 10:37:27', '2021-07-06 10:37:42', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (355, 'url', 'url', 'Input', 1, 0, NULL, 'http://localhost:8030', NULL, 1, '{\"regex\":{\"message\":\"URL 格式不符合规则!\"}}', '', NULL, '', 'Doris-0.14.x', 0, '2021-07-06 09:35:57', '2022-10-24 15:46:53', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (361, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:kylin://host:7070/project_name', NULL, '/jdbc:kylin:\\/\\/(.)+/', 'Kylin JDBC-3.x', 0, '2021-07-06 09:35:57', '2021-07-06 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (367, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:sqlserver://localhost:1433;DatabaseName=dbName', NULL, '/jdbc:sqlserver:\\/\\/(.)+/', 'SQLServer JDBC', 0, '2021-07-06 09:35:57', '2021-07-06 16:07:17', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (377, 'openKerberos', '开启 Kerberos 认证', 'Kerberos', 0, 0, NULL, NULL, NULL, 0, '', NULL, NULL, NULL, 'HDFS-2.x', 0, '2021-03-23 20:38:06', '2021-09-17 13:51:06', 0, 0, '');
...
INSERT INTO `datasource_form_field` VALUES (383, 'tbds_id', 'ID', 'Input', 1, 0, NULL, '请输入 ID', NULL, 0, '', NULL, NULL, NULL, 'HDFS-TBDS', 0, '2021-09-17 10:38:27', '2021-09-17 10:38:27', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (385, 'tbds_key', 'KEY', 'Input', 1, 0, NULL, '请输入 KEY', NULL, 0, '', NULL, NULL, NULL, 'HDFS-TBDS', 0, '2021-09-17 10:38:27', '2021-09-17 10:38:27', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (387, 'tbds_username', 'USERNAME', 'Input', 1, 0, NULL, '请输入 username', NULL, 0, '', NULL, NULL, NULL, 'HDFS-TBDS', 0, '2021-10-15 10:38:27', '2021-10-15 10:38:27', 0, 0, '');
INSERT INTO `datasource_form_field` VALUES (389, 'jdbcUrl', 'JDBC URL', 'Input', 1, 0, NULL, NULL, NULL, 1, '{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}', '示例：jdbc:oceanbase://host:port/dbName', NULL, '/jdbc:oceanbase:\\/\\/(.)+/', 'OceanBase', 0, '2021-08-05 09:35:57', '2021-08-05 16:07:17', 0, 0, '');
...
CREATE TABLE `datasource_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增 id',
  `data_type` varchar(64) COLLATE utf8_bin NOT NULL COMMENT '数据源类型唯一 如 Mysql, Oracle, Hive',
  `data_version` varchar(64) COLLATE utf8_bin DEFAULT NULL COMMENT '数据源版本 如 1.x, 0.9, 创建下的实例可能会没有版本号',
  `data_name` varchar(128) COLLATE utf8_bin NOT NULL COMMENT '数据源名称',
  `data_desc` text COLLATE utf8_bin COMMENT '数据源描述',
  `link_json` text COLLATE utf8_bin COMMENT '数据源连接信息，不同数据源展示连接信息不同，保存为 json',
  `data_json` text COLLATE utf8_bin COMMENT '数据源填写的表单信息，保存为 json, key 键要与表单的 name 相同',
  `status` tinyint(4) NOT NULL COMMENT '连接状态 0-连接失败，1-正常',
  `is_meta` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否有 meta 标志 0-否 1-是',
  `tenant_id` int(11) NOT NULL COMMENT '租户主键 id **可能不是 id 其他唯一凭证',
  `data_type_code` tinyint(4) NOT NULL DEFAULT '0' COMMENT '数据源类型编码',
  `schema_name` varchar(64) COLLATE utf8_bin DEFAULT '' COMMENT '数据源 schemaName',
  `is_deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否删除，1 删除，0 未删除',
  `gmt_create` datetime DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `datasource_type` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增 id',
  `data_type` varchar(64) COLLATE utf8_bin NOT NULL COMMENT '数据源类型唯一 如 Mysql, Oracle, Hive',
  `data_classify_id` int(11) NOT NULL COMMENT '数据源分类栏主键 id',
  `weight` decimal(20,1) NOT NULL DEFAULT '0.0' COMMENT '数据源权重',
  `img_url` varchar(256) COLLATE utf8_bin DEFAULT NULL COMMENT '数据源 logo 图片地址',
  `sorted` int(5) NOT NULL DEFAULT '0' COMMENT '数据源类型排序字段，默认从 0 开始',
...
CREATE TABLE `datasource_version` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增 id',
  `data_type` varchar(64) COLLATE utf8_bin NOT NULL COMMENT '数据源类型唯一 如 Mysql, Oracle, Hive',
  `data_version` varchar(64) COLLATE utf8_bin NOT NULL COMMENT '数据源版本 如 1.x, 0.9',
  `sorted` int(5) NOT NULL DEFAULT '0' COMMENT '版本排序字段，高版本排序，默认从 0 开始',
  `is_deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否删除，1 删除，0 未删除',
  `gmt_create` datetime DEFAULT CURRENT_TIMESTAMP,
  `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `create_user_id` int(11) DEFAULT '0',
...
CREATE TABLE `develop_catalogue` (
  ...
  `node_pid` int(11) NOT NULL DEFAULT '-1' COMMENT '父文件夹 id -1:没有上级目录',
  `order_val` int(3) DEFAULT NULL,
  `level` tinyint(1) NOT NULL DEFAULT '3' COMMENT '目录层级 0:一级 1:二级 n:n+1 级',
  `gmt_create` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
  `create_user_id` int(11) NOT NULL COMMENT '创建用户',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 正常 1 逻辑删除',
  `catalogue_type` tinyint(1) DEFAULT '0' COMMENT '目录类型 0 任务目录 1 项目目录',
  PRIMARY KEY (`id`),
...
INSERT INTO `develop_catalogue` VALUES (17, -1, 'Flink 系统函数', 0, 3, 1, '2022-10-24 15:45:34', '2022-10-24 15:45:34', -1, 0, 0);
...
CREATE TABLE `develop_function` (
  ...
  `class_name` varchar(512) COLLATE utf8_bin DEFAULT NULL COMMENT 'main 函数类名',
...
-- ----------------------------
BEGIN;
INSERT INTO `develop_function` VALUES (1, 'round', '', '取近似值', 'double  round(double a)  double  round(double a, int d)', 'round(double a)：返回对 a 四舍五入的 bigint 值  round(double a, int d)：返回 double 型 a 的保留 d 位小数的 double 型的近似值', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (3, 'bround', '', '银行家舍入法', 'double  bround(double a)  double  bround(double a, int d)', 'bround(double a)：1~4：舍，6~9：进，5->前位数是偶：舍，5->前位数是奇：进  bround(double a, int d)：保留 d 位小数', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (9, 'rand', '', '取随机数', 'double  rand()  double  rand(int seed)', '返回一个 0 到 1 范围内的随机数。如果指定种子 seed，则会等到一个稳定的随机数序列', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (11, 'exp', '', '计算自然指数的指数', 'double  exp(double a)  double  exp(decimal a)', '返回自然对数 e 的 a 幂次方，a 可为小数', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (13, 'ln', '', '计算自然数的对数', 'double  ln(double a)  double  ln(decimal a)', '以自然数为底 d 的对数，a 可为小数', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (15, 'log10', '', '计算 10 为底的对数', 'double  log10(double a)  double  log10(decimal a)', '计算以 10 为底 d 的对数，a 可为小数', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (17, 'log2', '', '计算 2 为底数的对数', 'double  log2(double a)  double  log2(decimal a)', '以 2 为底数 d 的对数，a 可为小数', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (19, 'log', '', '计算对数', 'double  log(double base, double a)  double  log(decimal base, decimal a)', '以 base 为底的对数，base 与 a 都是 double 类型', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (21, 'pow', '', '计算次幂', 'double  pow(double a, double p)', '计算 a 的 p 次幂', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (23, 'sqrt', '', '计算平方根', 'double  sqrt(double a)  double  sqrt(decimal a)', '计算 a 的平方根', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (25, 'bin', '', '计算二进制 a 的 string 类型，a 为 bigint 类型', 'string  bin(bigint a)', '计算二进制 a 的 string 类型，a 为 bigint 类型', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (27, 'hex', '', '计算十六进制的 string 类型', 'string  hex(bigint a)   string  hex(string a)   string  hex(binary a)', '计算十六进制 a 的 string 类型，如果 a 为 string 类型就转换成字符相对应的十六进制', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (29, 'unhex', '', 'hex 的逆方法', 'binary  unhex(string a)', 'hex 的逆方法', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (31, 'conv', '', '进制转换', 'string  conv(bigint num, int from_base, int to_base)  string  conv(string num, int from_base, int to_base)', '将 bigint/string 类型的 num 从 from_base 进制转换成 to_base 进制', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (33, 'abs', '', '计算 a 的绝对值', 'double  abs(double a)', '计算 a 的绝对值', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (35, 'pmod', '', 'a 对 b 取模', 'int  pmod(int a, int b),   double  pmod(double a, double b)', 'a 对 b 取模', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (53, 'positive', '', '返回 a', 'int positive(int a),   double  positive(double a)', '返回 a', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (55, 'negative', '', '计算相反数', 'int negative(int a),   double  negative(double a)', '返回 a 的相反数', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (57, 'sign', '', '计算数字的标志', 'double  sign(double a)  int  sign(decimal a)', 'sign(double a)：如果 a 是正数则返回 1.0，是负数则返回 -1.0，否则返回 0.0  sign(decimal a)：同上，返回值为整型', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (59, 'e', '', '取数学常数 e', 'double  e()', '取数学常数 e', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (61, 'pi', '', '取数学常数 pi', 'double  pi()', '取数学常数 pi', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (63, 'factorial', '', '计算阶乘', 'bigint  factorial(int a)', '求 a 的阶乘', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (65, 'cbrt', '', '计算立方根', 'double  cbrt(double a)', '计算 a 的立方根', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (67, 'shiftleft', '', '按位左移', 'int   shiftleft(TINYint|SMALLint|int a, int b)  bigint  shiftleft(bigint a, int 燽)', '按位左移', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (69, 'shiftright', '', '按拉右移', 'int  shiftright(TINYint|SMALLint|int a, intb)  bigint  shiftright(bigint a, int 燽)', '按拉右移', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (73, 'greatest', '', '求最大值', 'T  greatest(T v1, T v2, ...)', '返回数据列表中的最大值，当有元素时返回 NULL', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (75, 'least', '', '求最小值', 'T  least(T v1, T v2, ...)', '返回数据列表中的最小值，当有 NULL 元素时返回 NULL', 3, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (77, 'size', '', '求集合的长度', 'int  size(Map<K.V>)  int  size(Array<T>)', '参数为 Map 类型时，计算 Map 的长度，参数为数组时计算数组的长度', 5, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (79, 'map_keys', '', '返回 map 中的所有 key', 'array<K>  map_keys(Map<K.V>)', '返回 map 中的所有 key', 5, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (81, 'map_values', '', '返回 map 中的所有 value', 'array<V>  map_values(Map<K.V>)', '返回 map 中的所有 value', 5, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (83, 'array_contains', '', '判断数组是否包含指定值', 'boolean  array_contains(Array<T>, value)', '如该数组 Array<T>包含 value 返回 true。，否则返回 false', 5, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (87, 'row_number', '', '排序并获得排序后的编号', 'row_number() OVER (partition by COL1 order by COL2 desc ) rank', '表示根据 COL1 分组，在分组内部根据 COL2 排序，而此函数计算的值就表示每组内部排序后的顺序编号（组内连续的唯一的)', 5, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (89, 'from_unixtime', '', '格式化时间', 'string  from_unixtime(bigint unixtime[, string format])', '将时间的秒值转换成 format 格式（format 可为“yyyy-MM-dd hh:mm:ss”,“yyyy-MM-dd hh”,“yyyy-MM-dd hh:mm”等等）如 from_unixtime(1250111000,\"yyyy-MM-dd\") 得到 2009-03-12', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (91, 'unix_timestamp', '', '计算时间戳', 'bigint  unix_timestamp()  bigint  unix_timestamp(string date)  bigint  unix_timestamp(string date, string pattern)', '1.unix_timestamp()：获取本地时区下的时间戳  2.unix_timestamp(string date)：将格式为 yyyy-MM-dd HH:mm:ss 的时间字符串转换成时间戳，如 unix_timestamp(\"2009-03-20 11:30:01\") = 1237573801  3.unix_timestamp(string date, string pattern)：将指定时间字符串格式字符串转换成 Unix 时间戳，如果格式不对返回 0 如：unix_timestamp(\"2009-03-20\", \"yyyy-MM-dd\") = 1237532400', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (97, 'quarter', '', '计算季节', 'int  quarter(date/timestamp/string)', '返回当前时间属性哪个季度 如 quarter(\"2015-04-08\") = 2', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (111, 'datediff', '', '计算时间差', 'int  datediff(string enddate, string startdate)', '计算开始时间 startdate 到结束时间 enddate 相差的天数，如：datediff(\"2009-03-01\", \"2009-02-27\") = 2.', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (113, 'date_add', '', '从开始时间 startdate 加上 days', 'string  date_add(string startdate, int days)', '从开始时间 startdate 加上 days，如：date_add(\"2008-12-31\", 1) = \"2009-01-01\".', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (115, 'date_sub', '', '从开始时间 startdate 减去 days', 'string  date_sub(string startdate, int days)', '从开始时间 startdate 减去 days，如：date_sub(\"2008-12-31\", 1) = \"2008-12-30\".', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (117, 'from_utc_timestamp', '', '时间戳转换', 'timestamp  from_utc_timestamp(timestamp, string timezone)', '如果给定的时间戳是 UTC，则将其转化成指定的时区下时间戳，如：from_utc_timestamp(\"1970-01-01 08:00:00\",\"PST\")=1970-01-01 00:00:00.', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (119, 'to_utc_timestamp', '', '时间戳转换', 'timestamp  to_utc_timestamp(timestamp, string timezone)', '将给定的时间戳转换到 UTC 下的时间戳，如：to_utc_timestamp(\"1970-01-01 00:00:00\",\"PST\") =1970-01-01 08:00:00', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (125, 'add_months', '', '返回当前时间下再增加 num_months 个月的日期', 'string  add_months(string start_date, int num_months)', '返回 start_date 之后的 num_months 的日期。start_date 是一个字符串，日期或时间戳。num_months 是一个整数。start_date 的时间部分被忽略。如果 start_date 是本月的最后一天，或者如果生成的月份比 start_date 的日期组件少，那么结果是最后一个月的最后一天。否则，结果与 start_date 具有相同的日期组件', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (127, 'last_day', '', '返回这个月的最后一天的日期', 'string  last_day(string date)', '返回日期所属的月份的最后一天。date 是格式为\"yyyy-MM-dd HH：mm：ss\"或\"yyyy-MM-dd\"的字符串。日期的时间部分被忽略。', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (129, 'next_day', '', '返回当前时间的下一个星期 X 所对应的日期', 'string  next_day(string start_date, string day_of_week)', '返回当前时间的下一个星期 X 所对应的日期，如：next_day(\"2015-01-14\", \"TU\") = 2015-01-20 ?以 2015-01-14 为开始时间，其下一个星期二所对应的日期为 2015-01-20', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (133, 'months_between', '', '返回 date1 与 date2 之间相差的月份', 'double  months_between(date1, date2)', '返回 date1 与 date2 之间相差的月份，如 date1>date2，则返回正，如果 date1<date2，则返回负，否则返回 0.0 ?如：months_between(\"1997-02-28 10:30:00\", \"1996-10-30\") = 3.94959677 ?1997-02-28 10:30:00 与 1996-10-30 相差 3.94959677 个月', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (135, 'date_format', '', '时间格式化', 'string  date_format(date/timestamp/string ts, string fmt)', '按指定格式返回时间 date，如：date_format(\"2016-06-22\",\"MM-dd\")=06-22', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (137, 'if', '', '如果 testCondition 为 true 就返回 valueTrue，否则返回 valueFalseOrNull ', 'T  if(boolean testCondition, T valueTrue, T valueFalseOrNull)', 'valueTrue，valueFalseOrNull 为泛型', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (139, 'nvl', '', '如果 value 值为 NULL 就返回 default_value，否则返回 value', 'T  nvl(T value, T default_value)', '如果 value 值为 NULL 就返回 default_value，否则返回 value', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (141, 'coalesce', '', '返回第一非 null 的值', 'T  coalesce(T v1, T v2, ...)', '如果全部都为 NULL 就返回 NULL ?如：COALESCE (NULL,44,55)=44', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (143, 'isnull', '', '判断 a 是否为空', 'boolean  isnull( a )', '如果 a 为 null 就返回 true，否则返回 false', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (145, 'isnotnull', '', '判断 a 是否不为空', 'boolean  isnotnull ( a )', '如果 a 为非 null 就返回 true，否则返回 false', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (147, 'assert_true', '', '判断条件是否为真', 'assert_true(boolean condition)', '如果“条件”不为真，则抛出异常，否则返回 null（从 Hive 0.8.0 开始）', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (149, 'cast', '', '类型转换', 'type  cast(expr as <type>)', '将表达式 expr 的结果转换为<type>。例如，cast（\"1\"为 BIGINT）将字符串\"1\"转换为其整数表示。如果转换不成功，则返回 null。', 7, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (153, 'ascii', '', '返回 str 中首个 ASCII 字符串的整数值', 'int  ascii(string str)', '返回 str 中首个 ASCII 字符串的整数值', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (155, 'base64', '', '二进制转字符串', 'string  base64(binary bin)', '将二进制 bin 转换成 64 位的字符串', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (159, 'chr', '', '返回 A 对应的 ASCII 字符', 'string chr(bigint|double A)', '返回 A 对应的 ASCII 字符。如果 A 大于 256，则结果相当于 chr（A％256）。示例：chr（@date）=“X”。', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (161, 'context_ngrams', '', '返回出现次数 TOP K 的的子序列', 'array<struct<string,double>>  context_ngrams(array<array<string>>, array<string>, int K, int pf)', '返回出现次数 TOP K 的的子序列，但 context_ngram() 允许你预算指定上下文 (数组) 来去查找子序列', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (165, 'decode', '', '解码', 'string  decode(binary bin, string charset)', '使用指定的字符集 charset 将二进制值 bin 解码成字符串，支持的字符集有：\"US-ASCII\", \"ISO-8@math9-1\", \"UTF-8\", \"UTF-16BE\", \"UTF-16LE\", \"UTF-16\"，如果任意输入参数为 NULL 都将返回 NULL', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (167, 'encode', '', '编码', 'binary  encode(string src, string charset)', '使用指定的字符集 charset 将字符串编码成二进制值，支持的字符集有：\"US-ASCII\", \"ISO-8@math9-1\", \"UTF-8\", \"UTF-16BE\", \"UTF-16LE\", \"UTF-16\"，如果任一输入参数为 NULL 都将返回 NULL', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (169, 'find_in_set', '', '返回以逗号分隔的字符串中 str 出现的位置', 'int  find_in_set(string str, string strList)', '返回以逗号分隔的字符串中 str 出现的位置，如果参数 str 为逗号或查找失败将返回 0，如果任一参数为 NULL 将返回 NULL 回', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (171, 'format_number', '', '格式转换', 'string  format_number(number x, int d)', '将数值 X 转换成\"#,###,###.##\"格式字符串，并保留 d 位小数，如果 d 为 0，将进行四舍五入且不保留小数', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (173, 'get_json_object', '', '从指定路径获取 JSON 对象', 'string  get_json_object(string json_string, string path)', '从指定路径上的 JSON 字符串抽取出 JSON 对象，并返回这个对象的 JSON 格式，如果输入的 JSON 是非法的将返回 NULL，注意此路径上 JSON 字符串只能由数字 字母 下划线组成且不能有大写字母和特殊字符，且 key 不能由数字开头，这是由于 Hive 对列名的限制', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (175, 'in_file', '', '在指定文件中索引指定字符串', 'boolean  in_file(string str, string filename)', '如果文件名为 filename 的文件中有一行数据与字符串 str 匹配成功就返回 true', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (177, 'instr', '', '查找字符串 str 中子字符串 substr 出现的位置', 'int  instr(string str, string substr)', '查找字符串 str 中子字符串 substr 出现的位置，如果查找失败将返回 0，如果任一参数为 Null 将返回 null，注意位置为从 1 开始的', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (181, 'locate', '', '在位置 pos 之后返回 str 中第一次出现 substr 的位置', 'int  locate(string substr, string str[, int pos])', '在位置 pos 之后返回 str 中第一次出现 substr 的位置', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (183, 'lower', '', '将字符串 A 的所有字母转换成小写字母', 'string  lower(string A)', '将字符串 A 的所有字母转换成小写字母', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (185, 'lpad', '', '从左边开始对字符串 str 使用字符串 pad 填充，最终 len 长度为止，如果字符串 str 本身长度比 len 大的话，将去掉多余的部分', 'string  lpad(string str, int len, string pad)', '从左边开始对字符串 str 使用字符串 pad 填充，一直到长度为 len 为止，如果字符串 str 本身长度比 len 大的话，将去掉多余的部分', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (187, 'ltrim', '', '去掉字符串 A 前面的空格', 'string  ltrim(string A)', '去掉字符串 A 前面的空格', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (189, 'ngrams', '', '返回出现次数 TOP K 的的子序列', 'array<struct<string,double>>  ngrams(array<array<string>>, int N, int 燢，int pf)', '返回出现次数 TOP K 的的子序列，n 表示子序列的长度', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (191, 'parse_url', '', '返回从 URL 中抽取指定部分的内容', 'string  parse_url(string urlstring, string partToExtract [, string keyToExtract])', '返回从 URL 中抽取指定部分的内容，参数 url 是 URL 字符串，而参数 partToExtract 是要抽取的部分，这个参数包含 (HOST, PATH, QUERY, REF, PROTOCOL, AUTHORITY, FILE, and USERINFO，例如：parse_url(\"http://facebook.com/path1/p.php?k1=v1&k2=v2#Ref1\", \"HOST\") =\"facebook.com\"，如果参数 partToExtract 值为 QUERY 则必须指定第三个参数 key ?如：parse_url(\"http://facebook.com/path1/p.php?k1=v1&k2=v2#Ref1\", \"QUERY\", \"k1\") =‘v1’', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (193, 'printf', '', '按照 printf 风格格式输出字符串', 'string  printf(string format, Obj... args)', '按照 printf 风格格式输出字符串', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (195, 'regexp_extract', '', '返回使用模式提取的字符串', 'string  regexp_extract(string subject, string pattern, int index)', '抽取字符串 subject 中符合正则表达式 pattern 的第 index 个部分的子字符串，例如，regexp_extract(\"foothebar\", \"foo(.*?)(bar)\", 2)=\"bar\"。请注意，在使用预定义的字符类时需要注意：使用“s”作为第二个参数将匹配字母 s; \"\"需要匹配空格等', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (197, 'regexp_replace', '', '使用模式匹配替换字符串', 'string regexp_replace(string INITIAL_STRING, string PATTERN, string REPLACEMENT)', '按照 Java 正则表达式 PATTERN 将字符串 INITIAL_STRING 中符合条件的部分替换成 REPLACEMENT 所指定的字符串，如里 REPLACEMENT 为空的话，将符合正则的部分将被去掉 ?如：regexp_replace(\"foobar\", \"oo|ar\", \"\") = \"fb.\"。', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (199, 'repeat', '', '重复输出 n 次字符串 str', 'string  repeat(string str, int n)', '重复输出 n 次字符串 str', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (203, 'rpad', '', '字符串填充', 'string  rpad(string str, int len, string pad)', '从右边开始对字符串 str 使用字符串 pad 填充，一直到长度为 len 为止，如果字符串 str 本身长度比 len 大的话，将去掉多余的部分', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (207, 'sentences', '', '将字符串 str 将转换成单词数组', 'array<array<string>>  sentences(string str, string lang, string locale)', '字符串 str 将被转换成单词数组，如：sentences(\"Hello there! How are you?\") =( (\"Hello\", \"there\"), (\"How\", \"are\", \"you\") )', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (209, 'space', '', '返回 n 个空格', 'string  space(int n)', '返回 n 个空格', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (211, 'split', '', '按照正则表达式 pat 来分割字符串 str', 'array  split(string str, string pat)', '按照正则表达式 pat 来分割字符串 str，分割后以数组字符串的形式返回', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (213, 'str_to_map', '', '将字符串 str 按照指定分隔符转换成 Map', 'map<string,string>  str_to_map(text[, delimiter1, delimiter2])', '将字符串 str 按照指定分隔符转换成 Map，第一个参数是需要转换的字符串，第二个参数是键值对之间的分隔符，默认为逗号;第三个参数是键值之间的分隔符，默认为\"=\"', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (215, 'substr', '', '截取字符串', 'string  substr(string|binary A, int start) string  substr(string|binary A, int start, int len) ', '截取字符串 A 中 start 位置之后的字符串并返回  截取字符串 A 中 start 位置之后的长度为 length 的字符串', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (217, 'substring_index', '', '截取字符串', 'string  substring_index(string A, string delim, int count)', '截取第 count 分隔符之前的字符串，如 count 为正则从左边开始截取，如果为负则从右边开始截取', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (219, 'translate', '', '字符串替换', 'string  translate(string|char|varchar input, string|char|varchar from, string|char|varchar to)', '将 input 出现在 from 中的字符串替换成 to 中的字符串 如：translate(\"MOBIN\",\"BIN\",\"M\")=\"MOM\"', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (221, 'trim', '', '将字符串 A 前后出现的空格去掉', 'string  trim(string A)', '将字符串 A 前后出现的空格去掉', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (223, 'unbase64', '', '将 64 位的字符串转换二进制值', 'binary  unbase64(string str)', '将 64 位的字符串转换二进制值', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (225, 'upper', '', '将字符串 A 中的字母转换成大写字母', 'string  upper(string A)', '将字符串 A 中的字母转换成大写字母', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (231, 'soundex', '', '将普通字符串转换成 soundex 字符串', 'string  soundex(string A)', '将普通字符串转换成 soundex 字符串，如：soundex(\"Miller\") = M460.', 11, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (233, 'count', '', '统计总行数', 'bigint  count(*)  bigint  count(expr)  bigint  count(DISTINCT expr[, expr...])', '统计总行数，包括含有 NULL 值的行  统计提供非 NULL 的 expr 表达式值的行数  统计提供非 NULL 且去重后的 expr 表达式值的行数', 13, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (257, 'percentile', '', '返回 col 的 p%分位数', 'double  percentile(bigint col, p)', ' p 必须在 0 和 1 之间。注意：只能对整数值计算真正的百分位数。 ', 13, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (259, 'explode', '', '对于 a 中的每个元素，生成包含该元素的行', 'Array Type  explode(array<TYPE> a)  N rows  explode(ARRAY)  N rows  explode(MAP)', '对于 a 中的每个元素，生成包含该元素的行  从数组中的每个元素返回一行  从输入映射中为每个键值对返回一行，每行中有两列：一个用于键，另一个用于该值', 15, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (261, 'posexplode', '', '从数组中的每个元素返回一行', 'N rows  posexplode(ARRAY)', '与 explode 类似，不同的是还返回各元素在数组中的位置', 15, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (263, 'stack', '', '把 M 列转换成 N 行', 'N rows  stack(int n, v_1, v_2, ..., v_k)', '将 v_1，...，v_k 分解成 n 行。每行将有 k / n 列。n 必须是常数。', 15, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (265, 'json_tuple', '', '从一个 JSON 字符串中获取多个键并作为一个元组返回', 'tuple  json_tuple(jsonStr, k1, k2, ...)', '从一个 JSON 字符串中获取多个键并作为一个元组返回，与 get_json_object 不同的是此函数能一次获取多个键值', 15, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
INSERT INTO `develop_function` VALUES (267, 'parse_url_tuple', '', '返回从 URL 中抽取指定 N 部分的内容', 'tuple  parse_url_tuple(url, p1, p2, ...)', '返回从 URL 中抽取指定 N 部分的内容，参数 url 是 URL 字符串，而参数 p1,p2,....是要抽取的部分，这个参数包含 HOST, PATH, QUERY, REF, PROTOCOL, AUTHORITY, FILE, USERINFO, QUERY:<KEY>', 15, -1, -1, -1, 1, NULL, 0, '2022-02-12 23:33:10', '2022-02-12 23:33:10', 0, NULL);
...
INSERT INTO `develop_function` VALUES (273, 'ABS', '', '计算 numeric 的绝对值', 'ABS(numeric)', '计算 numeric 的绝对值。', 19, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
INSERT INTO `develop_function` VALUES (275, 'MOD', '', 'numeric1 对 numeric2 取模', 'MOD(numeric1, numeric2)', '返回 numeric1 除以 numeric2 的余数 (模数). 仅当 numeric1 为负时结果为负。', 19, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
INSERT INTO `develop_function` VALUES (277, 'SQRT', '', '计算平方根', 'SQRT(numeric)', '计算 numeric 平方根。', 19, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
INSERT INTO `develop_function` VALUES (279, 'LN', '', '	计算自然数的对数', 'LN(numeric)', '返回 numeric 的自然对数 (以 e 为底)', 19, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
INSERT INTO `develop_function` VALUES (281, 'LOG10', '', '	返回数字 10 的对数', 'LOG10(numeric) ', '返回 numeric 的对数 (以 10 为底)', 19, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
INSERT INTO `develop_function` VALUES (283, 'EXP', '', '	计算自然指数的指数', 'EXP(numeric)', '返回自然对数 e 的 numeric 幂次方', 19, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
...
INSERT INTO `develop_function` VALUES (307, 'SIGN', '', '计算数字的标志', 'SIGN(numeric)', '如果 numeric 是正数则返回 1.0, 是负数则返回 -1.0, 否则返回 0.0 ', 19, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
INSERT INTO `develop_function` VALUES (309, 'ROUND', '', '取近似值', 'ROUND(numeric, int)', '返回 numeric 的保留 int 位小数的近似值', 19, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
INSERT INTO `develop_function` VALUES (311, 'PI', '', '取数学常数 pi', 'PI()', '取数学常数 pi', 19, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
INSERT INTO `develop_function` VALUES (313, 'E', '', '取数学常数 e', 'E()', '取数学常数 e', 19, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
INSERT INTO `develop_function` VALUES (315, 'RAND', '', '取随机数', 'RAND() or RAND(seed integer)', '返回一个 0 到 1 范围内的随机数，如果指定种子 seed，则会等到一个稳定的随机数序列。', 19, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
INSERT INTO `develop_function` VALUES (317, 'RAND_INTEGER', '', '取随机数', 'RAND_INTEGER(bound integer) or RAND_INTEGER(seed integer, bound integer) ', '返回 0.0(包含) 和指定值 (不包括) 之间的伪随机整数值，如果指定种子 seed，则会等到一个稳定的随机数序列 ', 19, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
INSERT INTO `develop_function` VALUES (319, 'LOG', '', '计算对数', 'LOG(x numeric) or LOG(base numeric, x numeric)', '未指定 base 则以自然数 e 为底', 19, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
...
INSERT INTO `develop_function` VALUES (323, 'QUARTER', '', '计算季节', 'QUARTER(date)', '返回当前时间属性哪个季度 如 QUARTER(DATE \'1994-09-27\') 返回 3', 21, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
INSERT INTO `develop_function` VALUES (325, 'DATE_FORMAT', '', '时间格式化', 'DATE_FORMAT(timestamp, format)', '根据指定 format 格式化 timestamp 并返回字符串，format 必须和 mysql 的格式化语法兼容 (date_parse), 比如:DATE_FORMAT(ts, \'%Y, %d %M\') results in strings formatted as \'2017, 05 May\'', 21, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
INSERT INTO `develop_function` VALUES (327, 'TIMESTAMPADD', '', '时间加减操作', 'TIMESTAMPADD(unit, interval, timestamp)', '将 (有符号) 整数 interval 添加到 timestamp. interval 的单位由 unit 参数给出，它应该是以下值之一：SECOND, MINUTE, HOUR, DAY, WEEK, MONTH, QUARTER, or YEAR. 比如：TIMESTAMPADD(WEEK, 1, \'2003-01-02\') 返回 2003-01-09', 21, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:34', '2022-10-24 15:45:34', 0, NULL);
...
INSERT INTO `develop_function` VALUES (337, 'POSITION', '', '返回 string2 中第一次出现 string1 的位置', 'POSITION(string1 IN string2)', '返回 string2 中第一次出现 string1 的位置', 23, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:35', '2022-10-24 15:45:35', 0, NULL);
INSERT INTO `develop_function` VALUES (339, 'TRIM', '', '删除指定字符', 'TRIM( { BOTH | LEADING | TRAILING } string1 FROM string2)', '从 string2 中删除指定位置的 String1, 默认是删除前后的空格', 23, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:35', '2022-10-24 15:45:35', 0, NULL);
INSERT INTO `develop_function` VALUES (341, 'OVERLAY', '', '替换字符串', 'OVERLAY(string1 PLACING string2 FROM integer [ FOR integer2 ])', '用 string2 替换 string1 的子字符串', 23, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:35', '2022-10-24 15:45:35', 0, NULL);
INSERT INTO `develop_function` VALUES (343, 'SUBSTRING', '', '截取字符串', 'SUBSTRING(string FROM integer) or SUBSTRING(string FROM integer FOR integer)', '截取字符串中 start 位置之后的字符串并返回 截取字符串中 start 位置之后的长度为 length 的字符串', 23, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:35', '2022-10-24 15:45:35', 0, NULL);
...
INSERT INTO `develop_function` VALUES (351, 'COUNT', '', '统计总行数', 'COUNT(*) or COUNT(value [, value]* )', '统计总行数，包括含有 NULL 值的行，统计提供非 NULL 的 expr 表达式值的行数。', 25, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:35', '2022-10-24 15:45:35', 0, NULL);
...
INSERT INTO `develop_function` VALUES (369, 'COLLECT', '', '返回包含值的 multiset', 'COLLECT(value)', '返回包含值的 multiset. null 将被忽略。如果仅添加 null，则返回一个空 multiset.', 25, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:35', '2022-10-24 15:45:35', 0, NULL);
INSERT INTO `develop_function` VALUES (371, 'NULLIF', '', '如果值相同着返回 null', 'NULLIF(value, value)', '如果值相同着返回 null, 比如 NULLIF(5, 5) 返回 NULL; NULLIF(5, 0) 返回 5.', 27, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:35', '2022-10-24 15:45:35', 0, NULL);
INSERT INTO `develop_function` VALUES (373, 'COALESCE', '', '返回第一非 null 的值', 'COALESCE(value, value [, value ]* )', '返回第一非 null 的值，比如：COALESCE(NULL, 5) 返回 5.', 27, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:35', '2022-10-24 15:45:35', 0, NULL);
INSERT INTO `develop_function` VALUES (375, 'CAST', '', '类型转换', 'CAST(value AS type)', '将 value 转换为指定 type', 27, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:35', '2022-10-24 15:45:35', 0, NULL);
...
INSERT INTO `develop_function` VALUES (379, 'GROUPING', '', '如果表达式在当前行的分组集合中返回 1, 否则返回 0', 'GROUPING(expression)', '如果表达式在当前行的分组集合中返回 1, 否则返回 0.', 27, -1, -1, -1, 1, 0, 5, '2022-10-24 15:45:35', '2022-10-24 15:45:35', 0, NULL);
...
CREATE TABLE `develop_function_resource` (
                                             `id`           int(11)    NOT NULL AUTO_INCREMENT,
                                             `function_id`  int(11)    NOT NULL COMMENT '函数 id',
                                             `resource_id`  int(11)    NOT NULL COMMENT '对应 batch 资源的 id',
                                             `gmt_create`   datetime   NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
                                             `gmt_modified` datetime   NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
                                             `is_deleted`   tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 正常 1 逻辑删除',
...
(
    `id`              int(11)                       NOT NULL AUTO_INCREMENT,
    `job_id`          varchar(64) COLLATE utf8_bin  NOT NULL COMMENT '工作任务 id',
    `temp_table_name` varchar(256) COLLATE utf8_bin NOT NULL COMMENT '临时表名',
    `datasource_id`   int                                    default 0 null comment '数据源 id',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='sql 查询临时表';
...
CREATE TABLE `develop_task` (
  ...
  `compute_type` tinyint(1) NOT NULL COMMENT '计算类型 0 实时，1 离线',
  `sql_text` longtext COLLATE utf8_bin NOT NULL COMMENT 'sql 文本',
  `task_params` text COLLATE utf8_bin NOT NULL COMMENT '任务参数',
  `schedule_conf` varchar(512) COLLATE utf8_bin NOT NULL COMMENT '调度配置 json 格式',
  `period_type` tinyint(2) DEFAULT NULL COMMENT '周期类型',
  `schedule_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 未开始，1 正常调度，2 暂停',
  `submit_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 未提交，1 已提交',
  `gmt_create` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
  `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
  `modify_user_id` int(11) NOT NULL COMMENT '最后修改 task 的用户',
  `create_user_id` int(11) NOT NULL COMMENT '新建 task 的用户',
  `version` int(11) NOT NULL DEFAULT '0' COMMENT 'task 版本',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 正常 1 逻辑删除',
  ...
  `flow_id` int(11) NOT NULL DEFAULT '0' COMMENT '工作流 id',
  `component_version` varchar(25) COLLATE utf8_bin DEFAULT NULL COMMENT '组件版本',
  ...
  `queue_name` varchar(64) COLLATE utf8_bin DEFAULT NULL COMMENT 'yarn 队列名称',
  `datasource_id` int(11) DEFAULT NULL COMMENT '数据源 id',
  PRIMARY KEY (`id`),
...
CREATE TABLE `develop_task_param` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `task_id` int(11) NOT NULL COMMENT 'batch 任务 id',
...
CREATE TABLE `develop_task_resource` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `task_id` int(11) NOT NULL COMMENT 'batch 任务 id',
  `resource_id` int(11) DEFAULT NULL COMMENT '对应 batch 资源的 id',
...
CREATE TABLE `develop_task_task` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `task_id` int(11) NOT NULL COMMENT 'batch 任务 id',
  `parent_task_id` int(11) DEFAULT NULL COMMENT '对应 batch 任务父节点的 id',
  `tenant_id` int(11) NOT NULL COMMENT '租户 id',
...
CREATE TABLE `develop_task_version` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tenant_id` int(11) NOT NULL COMMENT '租户 id',
  `task_id` int(11) NOT NULL COMMENT '父文件夹 id',
  `origin_sql` longtext COLLATE utf8_bin COMMENT '原始 sql',
  `sql_text` longtext COLLATE utf8_bin NOT NULL COMMENT 'sql 文本',
  ...
  `schedule_conf` varchar(512) COLLATE utf8_bin NOT NULL COMMENT '调度配置 json 格式',
  `schedule_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 未开始，1 正常调度，2 暂停',
  `dependency_task_ids` text COLLATE utf8_bin NOT NULL COMMENT '依赖的任务 id，多个以，号隔开',
  `gmt_create` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
  `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 正常 1 逻辑删除',
  PRIMARY KEY (`id`)
...
INSERT INTO `dict` VALUES (135, 'tips', 'spark.submit.deployMode', 'spark driver 的 jvm 扩展参数', '1', 25, 0, 'STRING', '主要', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (137, 'tips', 'sparkPythonExtLibPath', '远程存储系统上 pyspark.zip 和 py4j-0.10.7-src.zip 的路径\n注：pyspark.zip 和 py4j-0.10.7-src.zip 在$SPARK_HOME/python/lib 路径下获取', '1', 25, 0, 'STRING', '主要', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (139, 'tips', 'sparkSqlProxyPath', '远程存储系统上 spark-sql-proxy.jar 路径\n注：spark-sql-proxy.jar 是用来执行 spark sql 的 jar 包', '1', 25, 0, 'STRING', '主要', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (141, 'tips', 'spark.yarn.maxAppAttempts', 'spark driver 最大尝试次数，默认为 yarn 上 yarn.resourcemanager.am.max-attempts 配置的值\n注：如果 spark.yarn.maxAppAttempts 配置的大于 yarn.resourcemanager.am.max-attempts 则无效', '1', 25, 0, 'STRING', '主要', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (143, 'tips', 'sparkYarnArchive', '远程存储系统上 spark jars 的路径', '1', 25, 0, 'STRING', '主要', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (145, 'tips', 'yarnAccepterTaskNumber', '允许 yarn 上同时存在状态为 accepter 的任务数量，当达到这个值后会禁止任务提交', '1', 25, 0, 'STRING', '主要', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (147, 'tips', 'spark.speculation', 'spark 任务推测行为', '1', 25, 0, 'STRING', '主要', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (149, 'tips', 'spark.executor.cores', '每个 executor 可以使用的 cpu 核数', '1', 25, 0, 'STRING', '资源', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (151, 'tips', 'spark.executor.memory', '每个 executor 可以使用的内存量', '1', 25, 0, 'STRING', '资源', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (153, 'tips', 'spark.executor.instances', 'executor 实例数', '1', 25, 0, 'STRING', '资源', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (155, 'tips', 'spark.cores.max', ' standalone 模式下任务最大能申请的 cpu 核数', '1', 25, 0, 'STRING', '资源', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (157, 'tips', 'spark.network.timeout', 'spark 中所有网络交互的最大超时时间', '1', 25, 0, 'STRING', '网络', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
...
INSERT INTO `dict` VALUES (161, 'tips', 'spark.executor.heartbeatInterval', 'driver 和 executor 之间心跳时间间隔', '1', 25, 0, 'STRING', '网络', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (163, 'tips', 'spark.eventLog.compress', '是否对 spark 事件日志进行压缩', '1', 25, 0, 'STRING', '事件日志', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (165, 'tips', 'spark.eventLog.dir', 'spark 事件日志存放路径', '1', 25, 0, 'STRING', '事件日志', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
...
INSERT INTO `dict` VALUES (169, 'tips', 'spark.driver.extraJavaOptions', 'spark driver 的 jvm 扩展参数', '1', 25, 0, 'STRING', 'JVM', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (171, 'tips', 'spark.executor.extraJavaOptions', 'spark executor 的 jvm 扩展参数', '1', 25, 0, 'STRING', 'JVM', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (173, 'tips', 'spark.yarn.appMasterEnv.PYSPARK_DRIVER_PYTHON', 'driver 中用于执行 pyspark 任务的 python 二进制可执行文件路径', '1', 25, 0, 'STRING', '环境变量', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (175, 'tips', 'spark.yarn.appMasterEnv.PYSPARK_PYTHON', '用于执行 pyspark 任务的 python 二进制可执行文件路径', '1', 25, 0, 'STRING', '环境变量', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
...
INSERT INTO `dict` VALUES (183, 'tips', 'high-availability', 'flink ha 类型', '0', 25, 0, 'STRING', '高可用', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (185, 'tips', 'high-availability.zookeeper.quorum', 'zookeeper 地址，当 ha 选择是 zookeeper 时必填', '0', 25, 0, 'STRING', '高可用', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (187, 'tips', 'high-availability.zookeeper.path.root', 'ha 节点路径', '0', 25, 0, 'STRING', '高可用', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (189, 'tips', 'high-availability.storageDir', 'ha 元数据存储路径', '0', 25, 0, 'STRING', '高可用', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (191, 'tips', 'prometheusHost', 'prometheus 地址，平台端使用', '0', 25, 0, 'STRING', '数栈平台参数', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
...
INSERT INTO `dict` VALUES (195, 'tips', 'metrics.reporter.promgateway.class', '用来推送指标类', '0', 25, 0, 'STRING', 'metric 监控', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (197, 'tips', 'metrics.reporter.promgateway.host', 'promgateway 地址', '0', 25, 0, 'STRING', 'metric 监控', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (199, 'tips', 'metrics.reporter.promgateway.port', 'promgateway 端口', '0', 25, 0, 'STRING', 'metric 监控', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (201, 'tips', 'metrics.reporter.promgateway.deleteOnShutdown', '任务结束后是否删除指标', '0', 25, 0, 'STRING', 'metric 监控', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (203, 'tips', 'metrics.reporter.promgateway.jobName', '指标任务名', '0', 25, 0, 'STRING', 'metric 监控', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (205, 'tips', 'metrics.reporter.promgateway.randomJobNameSuffix', '是否在任务名上添加随机值', '0', 25, 0, 'STRING', 'metric 监控', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (207, 'tips', 'state.backend', '状态后端', '0', 25, 0, 'STRING', '容错和 checkpointing', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (209, 'tips', 'state.backend.incremental', '是否开启增量', '0', 25, 0, 'STRING', '容错和 checkpointing', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (211, 'tips', 'state.checkpoints.dir', 'checkpoint 路径地址', '0', 25, 0, 'STRING', '容错和 checkpointing', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (213, 'tips', 'state.checkpoints.num-retained', 'checkpoint 保存个数', '0', 25, 0, 'STRING', '容错和 checkpointing', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (215, 'tips', 'state.savepoints.dir', 'savepoint 路径', '0', 25, 0, 'STRING', '容错和 checkpointing', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (217, 'tips', 'checkpoint.retain.time', '检查点保留时间', '0', 25, 0, 'STRING', '容错和 checkpointing', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
...
INSERT INTO `dict` VALUES (223, 'tips', 'akka.ask.timeout', 'akka 通讯超时时间', '0', 25, 0, 'STRING', '高级', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
...
INSERT INTO `dict` VALUES (227, 'tips', 'env.java.opts', 'jvm 参数', '0', 25, 0, 'STRING', 'JVM 参数', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
...
INSERT INTO `dict` VALUES (235, 'tips', 'classloader.dtstack-cache', '是否缓存 classloader', '0', 25, 0, 'STRING', '数栈平台参数', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (237, 'tips', 'sessionStartAuto', '是否允许 engine 启动 flink session', '0', 25, 0, 'STRING', '数栈平台参数', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (239, 'tips', 'checkSubmitJobGraphInterval', 'session check 间隔（60 * 10s）', '0', 25, 0, 'STRING', '数栈平台参数', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (241, 'tips', 'flinkLibDir', 'session check 间隔（60 * 10s）', '0', 25, 0, 'STRING', '数栈平台参数', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (243, 'tips', 'chunjunDistDir', 'flinkx plugins 父级本地目录', '0', 25, 0, 'STRING', '数栈平台参数', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
...
INSERT INTO `dict` VALUES (247, 'tips', 'remoteChunjunDistDir', 'flinkx plugins 父级远程目录', '0', 25, 0, 'STRING', '数栈平台参数', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (249, 'tips', 'flinkSessionName', 'yarn session 名称', '0', 25, 0, 'STRING', '数栈平台参数', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (251, 'tips', 'monitorAcceptedApp', '是否监控 yarn accepted 状态任务', '0', 25, 0, 'STRING', '数栈平台参数', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (253, 'tips', 'yarnAccepterTaskNumber', '允许 yarn accepter 任务数量，达到这个值后不允许任务提交', '0', 25, 0, 'STRING', '数栈平台参数', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (255, 'tips', 'slotmanager.number-of-slots.max', 'flink session 允许的最大 slot 数', '0', 25, 0, 'STRING', '公共参数', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (257, 'tips', 'sessionRetryNum', 'session 重试次数，达到后会放缓重试的频率', '0', 25, 0, 'STRING', '数栈平台参数', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (259, 'tips', 'restart-strategy', 'none, off, disable:无重启策略。Fixed -delay, Fixed -delay:固定延迟重启策略。更多细节可以在这里找到。Failure -rate:故障率重启策略。更多细节可以在这里找到。如果检查点被禁用，默认值为 none。如果检查点启用，默认值是 fixed-delay with Integer。MAX_VALUE 重启尝试和\'1 s\'延迟。', '0', 25, 0, 'STRING', '容错和 checkpointing', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (261, 'tips', 'restart-strategy.failure-rate.delay', '如果 restart-strategy 设置为根据失败率重试，则两次连续重启尝试之间的延迟。可以用“1 分钟”、“20 秒”来表示', '0', 25, 0, 'STRING', '容错和 checkpointing', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
...
INSERT INTO `dict` VALUES (265, 'tips', 'restart-strategy.failure-rate.failure-rate-interval', '如果重启策略设置为故障率，测量故障率的时间间隔。可以用“1 分钟”、“20 秒”来表示。', '0', 25, 0, 'STRING', '容错和 checkpointing', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (267, 'tips', 'restart-strategy.failure-rate.max-failures-per-interval', '如果 restart-strategy 设置为根据失败率重试，在给定的时间间隔内，任务失败前的最大重启次数。', '0', 25, 0, 'STRING', '容错和 checkpointing', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (269, 'tips', 'jdbcUrl', 'jdbc url 地址', '4', 25, 0, 'STRING', '', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (271, 'tips', 'jdbcUrl', 'jdbc url 地址', '5', 25, 0, 'STRING', '', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (273, 'tips', 'username', 'jdbc 连接用户名', '4', 25, 0, 'STRING', '', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (275, 'tips', 'username', 'jdbc 连接用户名', '5', 25, 0, 'STRING', '', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (277, 'tips', 'password', 'jdbc 连接密码', '4', 25, 0, 'STRING', '', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
INSERT INTO `dict` VALUES (279, 'tips', 'password', 'jdbc 连接密码', '5', 25, 0, 'STRING', '', 0, '2022-06-08 20:18:44', '2022-06-08 20:18:44', 0);
...
(
    `id`           int(11)                      NOT NULL AUTO_INCREMENT,
    `job_id`       varchar(64) COLLATE utf8_bin NOT NULL COMMENT '任务 id',
    `job_name`     varchar(256) COLLATE utf8_bin         DEFAULT NULL COMMENT '任务名称',
    `compute_type` tinyint(2)                   NOT NULL COMMENT '计算类型 stream/batch',
    `stage`        tinyint(2)                   NOT NULL COMMENT '处于 master 等待队列：1 还是 exe 等待队列 2',
    `job_info`     longtext COLLATE utf8_bin    NOT NULL COMMENT 'job 信息',
    `node_address` varchar(256) COLLATE utf8_bin         DEFAULT NULL COMMENT '节点地址',
    `job_resource` varchar(256) COLLATE utf8_bin         DEFAULT NULL COMMENT 'job 的计算引擎资源类型',
...
(
    ...
    `job_id`            varchar(64) COLLATE utf8_bin NOT NULL COMMENT '离线任务 id',
    `engine_job_id`     varchar(256) COLLATE utf8_bin         DEFAULT NULL COMMENT '离线任务计算引擎 id',
    `application_id`    varchar(256) COLLATE utf8_bin         DEFAULT NULL COMMENT '独立运行的任务需要记录额外的 id',
...
(
    ...
    `run_day`              varchar(64) COLLATE utf8_bin NOT NULL COMMENT '补数据运行日期 yyyy-MM-dd',
    `from_day`             varchar(64) COLLATE utf8_bin          DEFAULT NULL COMMENT '补数据开始业务日期 yyyy-MM-dd',
    `to_day`               varchar(64) COLLATE utf8_bin          DEFAULT NULL COMMENT '补数据结束业务日期 yyyy-MM-dd',
    `gmt_create`           datetime                     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
    `gmt_modified`         datetime                     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
    `create_user_id`       int(11)                      NOT NULL COMMENT '发起操作的用户',
    `is_deleted`           tinyint(1)                   NOT NULL DEFAULT '0' COMMENT '0 正常 1 逻辑删除',
    `fill_data_info`       mediumtext COLLATE utf8_bin COMMENT '补数据信息',
    `fill_generate_status` tinyint(2)                   NOT NULL DEFAULT '0' COMMENT '补数据生成状态：0 默认值，按照原来的接口逻辑走。1 表示正在生成，2 完成生成补数据实例，3 生成补数据失败',
    PRIMARY KEY (`id`),
...
(
    ...
    `tenant_id`         int(11)                       NOT NULL COMMENT '租户 id',
    `job_id`            varchar(64) COLLATE utf8_bin  NOT NULL COMMENT '工作任务 id',
    `job_key`           varchar(128) COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '工作任务 key',
    ...
    `create_user_id`    int(11) NOT NULL COMMENT '发起操作的用户',
    `is_deleted`        tinyint(1) NOT NULL                    DEFAULT '0' COMMENT '0 正常 1 逻辑删除',
    `type`              tinyint(1) NOT NULL                    DEFAULT '2' COMMENT '0 正常调度 1 补数据 2 临时运行',
    ...
    `flow_job_id`       varchar(64) COLLATE utf8_bin NOT NULL  DEFAULT '0' COMMENT '工作流实例 id',
    `period_type`       tinyint(2)                             DEFAULT NULL COMMENT '周期类型',
    `status`            tinyint(1) NOT NULL                    DEFAULT '0' COMMENT '任务状态 UNSUBMIT(0),CREATED(1),SCHEDULED(2),DEPLOYING(3),RUNNING(4),FINISHED(5),CANCELING(6),CANCELED(7),FAILED(8)',
    `task_type`         tinyint(1) NOT NULL COMMENT '任务类型 -1:虚节点，0:sparksql, 1:spark, 2:数据同步，3:pyspark, 4:R, 5:深度学习，6:python, 7:shell, 8:机器学习，9:hadoopMR, 10:工作流，12:carbonSQL, 13:notebook, 14:算法实验，15:libra sql, 16:kylin, 17:hiveSQL',
    `fill_id`           int(11)                                DEFAULT '0' COMMENT '补数据 id，默认为 0',
    `exec_start_time`   datetime                               DEFAULT NULL COMMENT '执行开始时间',
    `exec_end_time`     datetime                               DEFAULT NULL COMMENT '执行结束时间',
    ...
    `engine_job_id`     varchar(128) COLLATE utf8_bin          DEFAULT NULL COMMENT '离线任务计算引擎 id',
    `application_id`    varchar(128) COLLATE utf8_bin          DEFAULT NULL COMMENT '独立运行的任务需要记录额外的 id',
    `compute_type`      tinyint(1)                    NOT NULL DEFAULT '1' COMMENT '计算类型 STREAM(0), BATCH(1)',
...
(
    ...
    `job_graph`         mediumtext COLLATE utf8_bin COMMENT 'jobGraph 构建 json',
...
(
    `id`           int(11)    NOT NULL AUTO_INCREMENT,
    `trigger_type` tinyint(3) NOT NULL COMMENT '0:正常调度 1 补数据',
    `trigger_time` datetime   NOT NULL COMMENT '调度时间',
    `gmt_create`   datetime   NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
    `gmt_modified` datetime   NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
    `is_deleted`   int(10)    NOT NULL DEFAULT '0' COMMENT '0 正常 1 逻辑删除',
    PRIMARY KEY (`id`),
...
(
    `id`              int(11)     NOT NULL AUTO_INCREMENT,
    `job_id`          varchar(32) NOT NULL COMMENT '工作任务 id',
    `exec_start_time` datetime             DEFAULT NULL COMMENT '执行开始时间',
    `exec_end_time`   datetime             DEFAULT NULL COMMENT '执行结束时间',
    `engine_job_id`   varchar(256)         DEFAULT NULL COMMENT '额外 id',
...
(
    `id`             int(11)                       NOT NULL AUTO_INCREMENT,
    `tenant_id`      int(11)                       NOT NULL COMMENT '租户 id',
    `job_key`        varchar(256) COLLATE utf8_bin NOT NULL COMMENT 'batch 任务 key',
    `parent_job_key` varchar(256) COLLATE utf8_bin          DEFAULT NULL COMMENT '对应 batch 任务父节点的 key',
    `job_key_type`   int(11)                       NOT NULL DEFAULT '2' COMMENT 'parentJobKey 类型：RelyType 1. 自依赖实例 key 2. 上游任务 key 3. 上游任务的下一个周期 key',
    `rule`           int(11)                                DEFAULT NULL COMMENT 'parentJobKey 类型：RelyType 1. 自依赖实例 key 2. 上游任务 key 3. 上游任务的下一个周期 key',
    `gmt_modified`   datetime                      NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
    `gmt_create`     datetime                      NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
    `is_deleted`     tinyint(1)                    NOT NULL DEFAULT '0' COMMENT '0 正常 1 逻辑删除',
    PRIMARY KEY (`id`),
...
(
    `id`                int(11)                       NOT NULL AUTO_INCREMENT,
    `job_id`            varchar(255) COLLATE utf8_bin NOT NULL COMMENT '任务 id',
    `version`           int(10)                                DEFAULT '0' COMMENT '版本号',
    `operator_expired`  datetime                      NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '操作过期时间',
    `operator_type`     tinyint(1)                    NOT NULL DEFAULT '0' COMMENT '操作类型 0 杀死 1 重跑 2 补数据',
    `force_cancel_flag` tinyint(1)                    NOT NULL DEFAULT '0' COMMENT '强制标志 0 非强制 1 强制',
...
(
    `id`                int(11)                       NOT NULL AUTO_INCREMENT,
    `tenant_id`         int(11)                       NOT NULL DEFAULT '-1' COMMENT '租户 id',
    ...
    `modify_user_id`    int(11)                       NOT NULL COMMENT '最后修改 task 的用户',
    `create_user_id`    int(11)                       NOT NULL COMMENT '新建 task 的用户',
    `version_id`        int(11)                       NOT NULL DEFAULT '0' COMMENT 'task 版本',
    `is_deleted`        tinyint(1)                    NOT NULL DEFAULT '0' COMMENT '0 正常 1 逻辑删除',
...
(
    ...
    `value`           varchar(255) NOT NULL COMMENT '指标 key',
  `metric_tag` int(11) NOT NULL COMMENT 'metric 匹配模式',
...
) ENGINE=InnoDB AUTO_INCREMENT=256 DEFAULT CHARSET=utf8 COMMENT='任务支持的 metric 指标';

-- ----------------------------
-- Records of stream_metric_support
-- ----------------------------
BEGIN;
INSERT INTO `stream_metric_support` VALUES (143, 'jobmanager cpu 负载', 99, 'flink_jobmanager_Status_JVM_CPU_Load', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (145, 'jobmanager cpu 使用时间', 99, 'flink_jobmanager_Status_JVM_CPU_Time', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (147, 'taskmanager cpu 负载', 99, 'flink_taskmanager_Status_JVM_CPU_Load', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (149, 'taskmanager cpu 使用时间', 99, 'flink_taskmanager_Status_JVM_CPU_Time', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (151, 'bmanager jvm 最大堆内存', 99, 'flink_jobmanager_Status_JVM_Memory_Heap_Max', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (153, 'taskmanager jvm 最大堆内存', 99, 'flink_taskmanager_Status_JVM_Memory_Heap_Max', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (155, 'jobmanager jvm 堆内存使用量', 99, 'flink_jobmanager_Status_JVM_Memory_Heap_Used', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (157, 'taskmanager jvm 堆内存使用量', 99, 'flink_taskmanager_Status_JVM_Memory_Heap_Used', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (159, 'jobmanager jvm 最大非堆内存', 99, 'flink_jobmanager_Status_JVM_Memory_NonHeap_Max', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (161, 'taskmanager jvm 最大非堆内存', 99, 'flink_taskmanager_Status_JVM_Memory_NonHeap_Max', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (163, 'jobmanager jvm 非堆内存使用量', 99, 'flink_jobmanager_Status_JVM_Memory_NonHeap_Used', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (165, 'taskmanager jvm 非堆内存使用量', 99, 'flink_taskmanager_Status_JVM_Memory_NonHeap_Used', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (167, 'jobmanager 直接缓冲区总容量', 99, 'flink_jobmanager_Status_JVM_Memory_Direct_TotalCapacity', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (169, 'taskmanager 直接缓冲区总容量', 99, 'flink_taskmanager_Status_JVM_Memory_Direct_TotalCapacity', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (171, 'jobmanager 直接缓冲区内存使用量', 99, 'flink_jobmanager_Status_JVM_Memory_Direct_MemoryUsed', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (173, 'taskmanager 直接缓冲区内存使用量', 99, 'flink_taskmanager_Status_JVM_Memory_Direct_MemoryUsed', 2, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
...
INSERT INTO `stream_metric_support` VALUES (187, '任务最后一次 checkpoint 花费时间', 99, 'flink_jobmanager_job_lastCheckpointDuration', 1, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (189, '任务最后一次 checkpoint 大小', 99, 'flink_jobmanager_job_lastCheckpointSize', 1, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (191, '任务 checkpoint 总数量', 99, 'flink_jobmanager_job_totalNumberOfCheckpoints', 1, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (193, '任务 checkpoint 失败数量', 99, 'flink_jobmanager_job_numberOfFailedCheckpoints', 1, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
...
INSERT INTO `stream_metric_support` VALUES (231, '各 source rps 数据输入', 5, 'flink_taskmanager_job_task_operator_flinkx_numReadPerSecond', 1, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (233, '各 source bps 数据输入', 5, 'flink_taskmanager_job_task_operator_flinkx_byteReadPerSecond', 1, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (235, '各 sink bps 数据输出', 5, 'flink_taskmanager_job_task_operator_flinkx_byteWritePerSecond', 1, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (237, '各 sink rps 输出', 5, 'flink_taskmanager_job_task_operator_flinkx_numWritePerSecond', 1, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
...
INSERT INTO `stream_metric_support` VALUES (241, '输入 rps', 6, 'flink_taskmanager_job_task_operator_flinkx_numReadPerSecond', 1, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (243, '输出 rps', 6, 'flink_taskmanager_job_task_operator_flinkx_numWritePerSecond', 1, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (245, '输入 bps', 6, 'flink_taskmanager_job_task_operator_flinkx_byteReadPerSecond', 1, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
INSERT INTO `stream_metric_support` VALUES (247, '输出 bps', 6, 'flink_taskmanager_job_task_operator_flinkx_byteWritePerSecond', 1, '1.12', '2021-09-26 17:04:01', '2021-09-26 17:04:01', 0);
...
CREATE TABLE `task_dirty_data_manage` (
                                          `id`                      int(11)     NOT NULL AUTO_INCREMENT,
                                          `task_id`                 int(11)     NOT NULL COMMENT '任务 id',
                                          `output_type`             varchar(25) NOT NULL COMMENT '输出类型 1.log2.jdbc',
                                          `max_rows`                int(11)     NOT NULL COMMENT '脏数据最大值',
                                          `max_collect_failed_rows` int(11)     NOT NULL COMMENT '失败条数',
                                          `link_info`               text        NOT NULL COMMENT '连接信息 json',
...
INSERT INTO `task_param_template` VALUES (15, 12, 'PYTHON', '', '## 每个 worker 所占内存，比如 512m\n# script.worker.memory=512m\n\n## 每个 worker 所占的 cpu 核的数量\n# script.worker.cores=1\n\n## worker 数量\n# script.worker.num=1\n\n## 是否独占机器节点\n# script.worker.exclusive=false\n\n## 任务优先级，值越小，优先级越高，范围:1-1000\njob.priority=10\n\n## 指定 work 运行节点，需要注意不要写 ip 应填写对应的 hostname\n# script.worker.nodes=\n\n## 指定 work 运行机架\n# script.worker.racks=\n\n## 日志级别可选 ALL, DEBUG, ERROR, FATAL, INFO, OFF, TRACE, WARN\nlogLevel=INFO', '2022-10-24 15:46:52', '2022-10-24 15:46:52', 0);
INSERT INTO `task_param_template` VALUES (17, 13, 'SHELL', '', '## 每个 worker 所占内存，比如 512m\n# script.worker.memory=512m\n\n## 每个 worker 所占的 cpu 核的数量\n# script.worker.cores=1\n\n## worker 数量\n# script.worker.num=1\n\n## 是否独占机器节点\n# script.worker.exclusive=false\n\n## 任务优先级，值越小，优先级越高，范围:1-1000\njob.priority=10\n\n## 指定 work 运行节点，需要注意不要写 ip 应填写对应的 hostname\n# script.worker.nodes=\n\n## 指定 work 运行机架\n# script.worker.racks=\n\n## 日志级别可选 ALL, DEBUG, ERROR, FATAL, INFO, OFF, TRACE, WARN\nlogLevel=INFO', '2022-10-24 15:46:52', '2022-10-24 15:46:52', 0);
COMMIT;
...
-- 在数据源中添加 doris-jdbc 数据源

INSERT INTO `datasource_version` values (38,'Doris','0.14.x(jdbc)',1,0,'2021-07-06 14:49:27','2021-07-06 14:49:42',0,0);
INSERT INTO `datasource_form_field` values (397,'jdbcUrl','JDBC URL','Input',1,0,NULL,NULL,NULL,1,'{\"regex\":{\"message\":\"JDBC URL 格式不符合规则!\"}}','示例：jdbc:mysql://host:3306/dbName',NULL,'/jdbc:mysql:\\/\\/(.)+/','Doris-0.14.x(jdbc)',0,'2022-10-24 15:46:53','2022-10-24 15:46:53',0,0,'');
INSERT INTO `datasource_form_field` values (399,'username','用户名','Input',1,0,NULL,NULL,NULL,1,'',NULL,NULL,NULL,'Doris-0.14.x(jdbc)',0,'2022-10-24 15:46:53','2022-10-24 15:46:53',0,0,'');
INSERT INTO `datasource_form_field` values (401,'password','密码','Password',0,0,NULL,NULL,NULL,0,'',NULL,NULL,NULL,'Doris-0.14.x(jdbc)',0,'2022-10-24 15:46:53','2022-10-24 15:46:53',0,0,'');
INSERT INTO `datasource_form_field` values (403,'schema','schema','Input',1,0,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,'Doris-0.14.x(jdbc)',0,'2022-10-24 15:46:53','2022-10-24 15:46:53',0,0,'');

-- 在任务类型中添加元数据采集类型
-- INSERT INTO `dict` VALUES (363, '17', 'MySQL', '{"actions":["SAVE_TASK","RUN_TASK","STOP_TASK","SUBMIT_TASK","OPERATOR_TASK"],"barItem":["task","dependency","task_params","env_params"],"formField":["datasource"],"renderKind":"editor","dataTypeCodes":[1]}', '', 30, 0, 'STRING', '', 0, '2022-10-24 15:46:53', '2022-10-24 15:46:53', 0);
INSERT INTO `dict` VALUES (311, '2', 'SYNC', '{\"actions\": [\"SAVE_TASK\", \"RUN_TASK\", \"STOP_TASK\", \"SUBMIT_TASK\", \"OPERATOR_TASK\"], \"barItem\": [\"task\", \"dependency\", \"task_config\", \"task_params\", \"env_params\"], \"formField\": [\"createModel\", \"syncModel\"], \"renderKind\": \"dataSync\", \"renderCondition\": {\"key\": \"createModel\", \"value\": 0, \"renderKind\": \"editor\"}, \"actionsCondition\": {\"key\": \"createModel\", \"value\": 0, \"actions\": [\"CONVERT_TASK\", \"SAVE_TASK\", \"RUN_TASK\", \"STOP_TASK\", \"SUBMIT_TASK\", \"OPERATOR_TASK\"]}}', NULL, 30, 2, 'STRING', '', 1, '2022-02-11 10:28:45', '2022-02-11 10:28:45', 0);

INSERT INTO `dict` values (416 , '28','元数据采集', '{\"actions\":[\"SAVE_TASK\",\"OPERATOR_TASK\"],\"barItem\":[\"task\",\"dependency\",\"task_config\",\"task_params\",\"env_params\"],\"formField\":[\"createModel\"],\"renderKind\":\"dataSync\",\"renderCondition\":{\"key\":\"createModel\",\"value\":0},\"actionsCondition\":{\"key\":\"createModel\",\"value\":0,\"actions\":[\"SAVE_TASK\",\"RUN_TASK\",\"STOP_TASK\",\"SUBMIT_TASK\",\"OPERATOR_TASK\"]}}','',30,0,'STRING','',0,'2023-11-22 15:46:53','2023-11-22 15:46:53',0);